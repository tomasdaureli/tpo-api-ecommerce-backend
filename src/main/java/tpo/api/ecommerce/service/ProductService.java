...
public class ProductService {
    ...
    private List<Product> createProductList() {
        ...
        products.add(new Product(1L, "Air Jordan 1 Mid SE", new BigDecimal("100"),
                "https://nikearprod.vtexassets.com/arquivos/ids/680007-1200-1200?width=1200&height=1200&aspect=true", 1,
        ...
        products.add(new Product(2L, "Nike Blazer Low 77", new BigDecimal("60"),
                "https://nikearprod.vtexassets.com/arquivos/ids/809171-1200-1200?width=1200&height=1200&aspect=true", 1,
        ...
        products.add(new Product(3L, "Nike Dunk Low", new BigDecimal("80"),
                "https://nikearprod.vtexassets.com/arquivos/ids/658418-1200-1200?width=1200&height=1200&aspect=true", 1,
        ...
        products.add(new Product(4L, "Air Jordan 4 Retro", new BigDecimal("150"),
                "https://nikearprod.vtexassets.com/arquivos/ids/730755-1200-1200?width=1200&height=1200&aspect=true", 1,
